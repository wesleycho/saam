...
##    right_url = right_response['response']['docs'][0]['descriptiveNonRepeating']['record_link']
    ...
    page_source.append('<h6><a href="luce_match">Skip</a></h6><h4><a href="luce_match_score">View the all-time favorites</a></h4> <a href="learn_more?id1={0}&id2={1}" target="_blank"><h4>Learn more about these artworks</h4></a>'.format(left_side, right_side))
